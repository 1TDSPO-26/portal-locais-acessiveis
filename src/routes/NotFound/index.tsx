            ...
            <section className="flex min-h-[70svh] items-start justify-center bg-white px-4 pt-8 text-left sm:px-6 sm:pt-12">
                <div className="w-full max-w-[620px] rounded-2xl bg-[#EFF6FF] px-8 py-10 sm:px-11 sm:py-12">
                    ...
                    <button title="Botão para retornar a página inicial">
                        <a href="/" className="inline-flex min-h-10 items-center justify-center rounded-md bg-[#005FCC] px-4 py-2 text-sm font-semibold text-[#FFFFFF] transition-colors hover:bg-[#005FCC] focus-visible:outline-3 focus-visible:outline-offset-3 focus-visible:outline-[#0F172A] ">Voltar para o início</a>
                    </button>
                </div>
            </section>
        </main>
